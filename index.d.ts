...
declare namespace advancedVariables {
	...
	type FunctionReturnType = string | number | Record<string, FunctionReturnType> | FunctionReturnType[]
	interface Options {
		/**
		 ...
		 */
		functions?: Record<string, ((...args: string[]) => FunctionReturnType)> | undefined;
		/**
